...
export function ShareSuccessModal({ onClose }: ShareSuccessModalProps) {
    return (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-[#1a1a24] border border-[var(--color-court-border)] rounded-xl w-full max-w-sm overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
